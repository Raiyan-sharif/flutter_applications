...
//                Log.d("Tokennnnnnn",device_token);
                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                    // login user
                    checkLogin(email, password,"f6Caz_i2oYc%3AAPA91bEqkEzBmGybiir5_B77YtZ4Vo1x-2HzhG-O1ZJZJWloNYVIHIlDTXod-i-rzS2T6k43IK502AW7uwQgxp2CtNbaCMr0ywiHSOH-R3kpmba7f9EZMXnDoIEYbgVwIRLIxNvMj8Wq");
                } else {
